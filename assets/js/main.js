  ...
  $(document).on("submit", "#news", function (e) {
    ...
    $.ajax({
      ...
      error: function (xhr, err) {
        ...
        $(".subscribe .success_msg").html(
          "<p class='alert alert-danger'>Oops!! An error occurred.</p>"
        );
      },
    });
    return false;
...
(function ($) {
  ...
  // End date for timer, return value of epochtimer.js goes here
  var date = new Date(
    "Mon May 09 2022 21:30:21 GMT-0400 (Eastern Daylight Time)"
  );
  ...
  $(".countdown").ClassyCountdown({
    ...
    labelsOptions: {
      ...
      style:
        "font-size:20px; text-transform:uppercase; font-family: Roboto; font-weight: 400;",
    },
    style: {
      days: {
        gauge: {
